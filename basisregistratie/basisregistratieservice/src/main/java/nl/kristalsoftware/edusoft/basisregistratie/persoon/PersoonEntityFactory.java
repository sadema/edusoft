...
public class PersoonEntityFactory implements EntityFactory<Persoon> {
    ...
    public Persoon create(JsonObject jsonDocument) {
        ...
        Map<String, String> fieldList = jsonHelper.getStringFields(jsonDocument, Arrays.asList("achternaam", "geboortedatum", "roepnaam", "voorletters", "deelnemernummer", "registratiedatum"));
    ...
    private Persoon setPersonData(Persoon persoon, Map<String,String> personFieldMap) {
